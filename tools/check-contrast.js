#!/usr/bin/env node
/*
 * check-contrast.js — measures every colour pair the home page actually uses, in both
 * themes, against WCAG 2.1 AA. Exits non-zero on any failure.
 *
...
console.log(`\n✓ All ${rows.length} pairs pass WCAG 2.1 AA in both themes.\n`);
